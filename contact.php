<?php 
	...
	#Your e-mail address
	define("__TO__", "tsm_smd@yahoo.com");

	#Message subject
	define("__SUBJECT__", "");

	#Success message
	define('__SUCCESS_MESSAGE__', "Pesan Anda telah terkirim. Terima kasih!");

	#Error message 
	define('__ERROR_MESSAGE__', "Maaf, ada kesalahan. Mohon ulangi sekali lagi. Terima kasih!");

	#Messege when one or more fields are empty
	define('__MESSAGE_EMPTY_FILDS__', "Mohon mengisi semua bagian. Terima kasih");
